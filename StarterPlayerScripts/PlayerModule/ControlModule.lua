...
function ControlModule:OnRenderStepped(dt)
	if self.activeController and self.activeController.enabled and self.humanoid then
		...
		if moveVector.Magnitude > 0.1 then
			...
			local accelTime = 9999
			self.speedRatio = math.min(self.speedRatio + dt * (1 / accelTime), 1);print("speedratioAccel");print(self.speedRatio)
			...
			local decelTime = 2
			self.speedRatio = math.max(self.speedRatio - dt * (1 / decelTime), 0);print("speedratioDecel");print(self.speedRatio)
